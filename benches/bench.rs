...
fn do_bench_extend_from_slice_std(b: &mut Bencher, dst_len: usize, src_len: usize) {
    let dst: Vec<_> = FromIterator::from_iter(0..dst_len);
    let src: Vec<_> = FromIterator::from_iter(dst_len..dst_len + src_len);
...
#[bench]
fn bench_extend_from_slice_0000_0000_std(b: &mut Bencher) {
    do_bench_extend_from_slice_std(b, 0, 0)
}
...
#[bench]
fn bench_extend_from_slice_0000_0010_std(b: &mut Bencher) {
    do_bench_extend_from_slice_std(b, 0, 10)
}
...
#[bench]
fn bench_extend_from_slice_0000_0100_std(b: &mut Bencher) {
    do_bench_extend_from_slice_std(b, 0, 100)
}
...
#[bench]
fn bench_extend_from_slice_0000_1000_std(b: &mut Bencher) {
    do_bench_extend_from_slice_std(b, 0, 1000)
}
...
#[bench]
fn bench_extend_from_slice_0010_0010_std(b: &mut Bencher) {
    do_bench_extend_from_slice_std(b, 10, 10)
}
...
#[bench]
fn bench_extend_from_slice_0100_0100_std(b: &mut Bencher) {
    do_bench_extend_from_slice_std(b, 100, 100)
}
...
#[bench]
fn bench_extend_from_slice_1000_1000_std(b: &mut Bencher) {
    do_bench_extend_from_slice_std(b, 1000, 1000)
}
